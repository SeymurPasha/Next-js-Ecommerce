...
export default function Home(props) {
  const rcmdItems1 = props.data.results.filter((i) => i.taxonomy_path[0] === 'Home & Living').slice(0, 6);
  ...
  return (
    <div className="homepage">
      <RecommendedItems title="Home/Living" shape="square" products={rcmdItems1} />
